 ...
 * 2020年4月17日下午5:47:24
 */
public enum BearCode implements IBaseCode {

    //系统相关 start
    SUCCESS(0, "成功"),
    FAIL(1001, "失败"),
    SESSION_TIMEOUT(1002, "session过期"),
    SESSION_NONE(1003, "session过期"),
    SYSTEM_BUSY(-1, "系统繁忙"),
    ...
    public BearCode build(String msg, Object... param) {
        this.msg = String.format(msg, param);
        return this;
    }

    public BearCode param(Object... param) {
        this.msg = String.format(msg, param);
        return this;
    }
}
